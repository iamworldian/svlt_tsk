<section class="bg-gradient h-full w-full py-2 xs:h-[76px] xs:py-0 lg:h-[46px]">
	<div class="container mx-auto flex h-full w-fit max-w-[960px] items-center justify-center px-3">
		<div
			class="flex max-w-[350px] items-start text-center sm:max-w-[500px] md:max-w-fit md:text-left lg:gap-1 text-3xl"
		>
			<span class="emoji">🚀</span>
			<p class="banner-text">
				<span class="text-[#00E7F9] font-extrabold">FRESH BEGINNINGS SALE:</span>
